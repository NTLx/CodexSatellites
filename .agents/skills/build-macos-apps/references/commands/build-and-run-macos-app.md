...
6. Follow the canonical bootstrap contract in `../build-run-debug/run-button-bootstrap.md` for the exact script shape and `.codex/environments/environment.toml` format.
